...
const UserAddOrder: React.FC = () => {
  ...
  return (
    <div className="bg-slate-100 w-full flex items-center justify-center">
      ...
      <form onSubmit={handleSubmit} className="flex items-center justify-center flex-col gap-5 w-2/3">
        <div className="flex justify-center items-center w-full">
          <label htmlFor="pickupLocation" className="font-semibold w-1/3">Pickup Location:</label>
          <input
            type="text"
            id="pickupLocation"
            name="pickupLocation"
        ...
        <div className="flex items-center justify-center w-full">
          <label htmlFor="dropoffLocation" className="font-semibold  w-1/3">Dropoff Location:</label>
          <input
            type="text"
            id="dropoffLocation"
        ...
        <div className="flex items-center justify-center w-full">
          <label htmlFor="receiverPhoneNo" className="font-semibold  w-1/3">Receiver Phone No:</label>
          <input
            type="text"
            id="receiverPhoneNo"
        ...
        <button type="submit" className="bg-orange-600 px-2 py-1 rounded-md font-semibold text-white text-md">Add Order</button>
      </form>
      </div>
    </div>
  );
